...
SEKAI_BLUE_BG = RandomTriangleBg(True, main_hue=0.50, size_fixed_rate=0)  # 启用时间颜色系统，三角形大小变化，数量固定
SEKAI_RED_BG = RandomTriangleBg(True, main_hue=0.05, size_fixed_rate=0)  # 启用时间颜色系统
